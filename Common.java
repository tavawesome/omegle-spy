...
public class Common
{
	...
	{
		int result = JOptionPane.showConfirmDialog(p, msg, "Warning",
	...
	public static InputStream getLocalFileInputStream (String fname)
		throws IOException
	{
	...
	public static void guiWriteHtmlFile (String text, Component p)
		throws IOException
	{
